...
An a priori power analysis is important for determining the required sample size for a study. A power analysis involves four variables, any three of which can be used to determine the fourth:
...
Typically, we are interested in determining the sample size needed for a study. To get this we can use the other three variables in our power analysis.
